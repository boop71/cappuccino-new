--this is a copy of uwuware but with kinlei's material lua functions
...
local function getFnctions(parent)
	...
	function parent:Dropdown(option)
		option = typeof(option) == "table" and option or {}
		option.text = tostring(option.text)
	...
	function parent:ColorPicker(option)
		option = typeof(option) == "table" and option or {}
		option.text = tostring(option.text)
